...
from grok2api.admin.local_tasks import router as local_tasks_router
...
def _admin_page(name: str = "index"):
    ...
    allowed = {
        ...
        "register-tasks": "register-tasks.html",
        "models": "models.html",
        "guide": "guide.html",
...
@app.get("/admin/register-tasks")
@app.get("/admin/register-tasks/")
async def admin_register_tasks_page():
    return _admin_or_404("register-tasks")
